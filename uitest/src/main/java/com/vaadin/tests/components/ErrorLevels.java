...
public class ErrorLevels extends AbstractTestUI {
    ...
    protected void setup(VaadinRequest request) {
        ...
        errorLevels = new ComboBox<>("Error level", Arrays.asList(ErrorMessage.ErrorLevel.values()));
    ...
    private void setErrorMessages() {
        ...
        borderlessButton.setComponentError(createErrorMessage("Borderless button error"));
        ...
        textFieldBorderless.setComponentError(createErrorMessage("Borderless text field error"));
    ...
    private ErrorMessage createErrorMessage(String text) {
        return new UserError(text, AbstractErrorMessage.ContentMode.TEXT, errorLevels.getValue());
    }
}
